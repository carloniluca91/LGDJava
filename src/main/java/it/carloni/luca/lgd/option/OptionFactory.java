...
public class OptionFactory {
    ...
    public static Option getStepNameOption() {
        ...
        return getRequiredOptionWithArg(OptionEnum.STEP_NAME_SHORT_OPTION,
                OptionEnum.STEP_NAME_LONG_OPTION,
                OptionEnum.STEP_NAME_OPTION_DESCRIPTION);
    }

    public static Option getDataAOpton(){

        return getRequiredOptionWithArg(OptionEnum.DATA_A_SHORT_OPTION,
    ...
    public static Option getDataDaOption(){
        ...
        return getRequiredOptionWithArg(OptionEnum.DATA_DA_SHORT_OPTION,
    ...
    public static Option getDataOsservazioneOption(){
        ...
        return getRequiredOptionWithArg(OptionEnum.DATA_OSSERVAZIONE_SHORT_OPTION,
    ...
    public static Option getUfficioOption(){
        ...
        return getRequiredOptionWithArg(OptionEnum.UFFICIO_SHORT_OPTION,
    ...
    public static Option getNumeroMesi1Option(){
        ...
        return getRequiredOptionWithArg(OptionEnum.NUMERO_MESI_1_SHORT_OPTION,
    ...
    public static Option getNumeroMesi2Option(){
        ...
        return getRequiredOptionWithArg(OptionEnum.NUMERO_MESI_2_SHORT_OPTION,
